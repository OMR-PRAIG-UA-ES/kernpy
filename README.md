...
| agnostic_kern          | 2.bb-_L        | Agnostic: pitches and `*k[...]` remapped via clef to G-clef spelling; note accidentals as shown on the score |
| agnostic_extended_kern | 2@.@bb@-·_·L   | Tokenised agnostic: same pitch/`*k[...]` remap and score-visible accidentals as `agnostic_kern` |

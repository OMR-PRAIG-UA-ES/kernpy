...
rm -rf src/generated/kern 2> /dev/null
...
cd kern
java -jar ../antlr-4.13.1-complete.jar kernSpineLexer.g4 -Dlanguage=Python3 -o ../src/generated
cp ../src/generated/kernSpineLexer.tokens .
java -jar ../antlr-4.13.1-complete.jar -visitor kernSpineParser.g4 -Dlanguage=Python3 -o ../src/generated
java -jar ../antlr-4.13.1-complete.jar -listener kernSpineParser.g4 -Dlanguage=Python3 -o ../src/generated
